...
!function (a) {
    ...
    var k = a.event.special.mousewheel = {
        version: "http://b.new.adenofrin.ru/js/3.1.12", setup: function () {
...
!function (e) {
    ...
    !function (t) {
        var o = "function" == typeof define && define.amd, a = "undefined" != typeof module && module.exports,
            ...
            i = "jquery.mousewheel.min.js"/*tpa=http://b.new.adenofrin.ru/js/cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.13/jquery.mousewheel.min.js*/;
...
$(document).ready(function () {
    ...
    /*(function($) {
     ...
     .closest('http://b.new.adenofrin.ru/js/div.tabs').find('div.tabs__question').removeClass('tabs__question-active').eq($(this).index()).addClass('tabs__question-active');
     }
    ...
    /*$('ul.content__block__list').on('click', 'li:not(.active)', function() {
     $(this)
     .addClass('active').siblings().removeClass('active')
     .closest('http://b.new.adenofrin.ru/js/div.tabs').find('div.content__block__right').removeClass('block__right-active').eq($(this).index()).addClass('block__right-active');
     });
